...
while not quitGame:
    ...
    #input = int(input('Enter a number 1-9: '))
        ...
        #board[input-1] = currentTurnPlayer
        #currentTurnPlayer == 'O'
    #else: 
...
#def checkWin(board):
    #if True:
        #print('Hurray! ' + currentTurnPlayer + ' .You won!')
...
#def validateMove():
    ...
    #ocount = move.count('O')
        ...
        #if checkWin(move, 'X') and xcount != ocount + 1:
            #return 'Invalid Input'

        #if not checkWin(move, 'O'):
            #return 'Valid Input'
...
"""
    if move == int(input()):
        print("It is Player 2's turn!" + move)
    else:
        print(move)
move += 1
"""
